package com.fbssln.helloworld.testweather.service;
...
public class AutoupdateService extends Service {
    ...
    private void updateWeather() {
        ...
        if (weatherString != null){
            ...
            String weatherUrl = "http://guol;in.tech/api/weather?cityid=" + weatherId + "&key=c240a1564121471d88eb8aec1d8bfc8d";
